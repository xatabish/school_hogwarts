...
public class Main {
    public static void main(String[] args) {
        ...
        Slytherin people4 = new Slytherin(" Драко ", " Малфой ", " Слизерин ", 30, 30, 32, 54, 87);
        Slytherin people5 = new Slytherin(" Грэхэм ", " Монтегю ", " Слизерин ", 20, 20, 92, 43, 56);
        Slytherin people6 = new Slytherin(" Седрик ", " Диггори", " Слизерин ", 10, 10, 65, 23, 34);

        Hufflepuff people7 = new Hufflepuff(" Захария ", " Смит ", " Пуффендуй ", 30, 30, 99, 56, 78);
        Hufflepuff people8 = new Hufflepuff(" Седрик ", " Диггори ", " Пуффендуй ", 20, 20, 34, 54, 12);
        Hufflepuff people9 = new Hufflepuff(" Джастин ", " Финч-Флетчли ", " Пуффендуй ", 10, 10, 12, 34, 65);

        Ravenclaw people10 = new Ravenclaw(" Чжоу ", " Чанг ", " Когтевран ", 30, 30, 78, 53, 65);
        Ravenclaw people11 = new Ravenclaw(" Падма ", " Патил ", " Когтевран ", 20, 20, 23, 67, 23);
        Ravenclaw people12 = new Ravenclaw(" Маркус ", " Белби ", " Когтевран ", 10, 10, 69, 23, 43);
